 ...
 */
fractal.web.set('static.path', path.join(__dirname, `../../${config.directories.buildDirectory}/${config.currentWebsite}`))
  ...
  middleware: [
    {
      ...
      handle: (request, response, next) => {
        ...
        let fileName = `${(requestUrlPath[requestUrlPath.length - 1])}.json`
